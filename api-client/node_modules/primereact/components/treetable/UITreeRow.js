...
var UITreeRow = exports.UITreeRow = function (_Component) {
    ...
    _createClass(UITreeRow, [{
        ...
        value: function render() {
            ...
            var tableRowClass = (0, _classnames2.default)('p-treetable-row', {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.treeTable.columns && this.treeTable.columns.map(function (col, i) {
                        ...
                        if (i === 0) {
                            var togglerClass = (0, _classnames2.default)('p-treetable-toggler pi pi-fw p-c', {
                            ...
                            if (_this2.treeTable.props.selectionMode === 'checkbox') {
                                var checkboxIconClass = (0, _classnames2.default)('p-checkbox-icon p-c pi', {
                                ...
                                checkbox = _react2.default.createElement(
                                    'div',
                                    { className: 'p-checkbox p-treetable-checkbox' },
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'p-checkbox-box p-component' },
                ...
                this.node.children && this.state.expanded && _react2.default.createElement(
                    'tr',
                    { className: 'p-treetable-row', style: { 'display': 'table-row' } },
                    _react2.default.createElement(
                        'td',
                        { colSpan: this.treeTable.columns.length, className: 'p-treetable-child-table-container' },
                        _react2.default.createElement(
                            'table',
                            null,
                            childTbody
