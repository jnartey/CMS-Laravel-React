    ...
    _createClass(TreeTableHeaderCell, [{
        ...
        value: function onClick(e) {
            if (this.props.sortable) {
                ...
                if (_DomHandler2.default.hasClass(targetNode, 'p-sortable-column') || _DomHandler2.default.hasClass(targetNode, 'p-column-title') || _DomHandler2.default.hasClass(targetNode, 'p-sortable-column-icon')) {
                    this.props.onSort({
                        originalEvent: e,
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-unselectable-text', { 'p-sortable-column': this.props.sortable, 'p-highlight': sorted }, this.props.className);

            if (this.props.sortable) {
                var sortIcon = sorted ? sortOrder < 0 ? 'pi-sort-down' : 'pi-sort-up' : 'pi-sort';
                sortIconElement = _react2.default.createElement('span', { className: (0, _classnames2.default)('p-sortable-column-icon pi pi-fw', sortIcon) });
            }
